...
const ModalRest: React.FC<IModal> = (props:IModal) => {
  ...
  return (
    <div className="restaurants-card">
      <div id="restaurants-card-Modal" className="modal">
		...
		<span
		  ...
		  <DishCard
					  ...
					  price={dishesData[IdNum].price} id={dishesData[IdNum].id} title={"card-dish-information-modal"} dishtitle={"dish-card-element-Modal"}          />
					...
					<div className="highlight">Choose a side</div>	
					 ...
					 <div>
					  ...
					  <div  id="Quantity">
					  <button id="symbol" onClick={handleMinus}>-</button>
					  <div id="symbol">{number}</div>
					  <button  id="symbol" onClick={handlePlus}>+</button>
					  </div>
					  <div>
